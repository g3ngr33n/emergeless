...
inherit pam multilib libtool systemd toolchain-funcs
...
LICENSE="ISC BSD"
SLOT="0"
IUSE="gcrypt ldap nls offensive pam sasl +secure-path selinux +sendmail skey ssl sssd tmpfiles"
...
src_configure() {
	...
	myeconfargs=(
		...
		--without-linux-audit
		--without-opie
		$(use_enable tmpfiles tmpfiles.d "{$EPREFIX}"/usr/lib/tmpfiles.d)
		$(use_enable gcrypt)
		$(use_enable nls)
		$(use_enable sasl)
