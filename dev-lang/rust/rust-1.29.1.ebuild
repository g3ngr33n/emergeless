...
CARGO_DEPEND_VERSION="0.$(($(ver_cut 2))).0"
...
SRC_URI="https://static.rust-lang.org/dist/${SRC} -> rustc-${PV}-src.tar.xz
	amd64? (
		elibc_glibc? ( https://static.rust-lang.org/dist/rust-${PV}-x86_64-unknown-linux-gnu.tar.xz )
...
PATCHES=(
	"${FILESDIR}/1.29.0/0001-Require-static-native-libraries-when-linking-static-.patch"
	"${FILESDIR}/1.29.0/0002-Remove-nostdlib-and-musl_root-from-musl-targets.patch"
	"${FILESDIR}/1.29.0/0003-Switch-musl-targets-to-link-dynamically-by-default.patch"
	"${FILESDIR}/1.29.0/0004-Prefer-libgcc_eh-over-libunwind-for-musl.patch"
	"${FILESDIR}/1.29.0/0005-Fix-LLVM-build.patch"
	"${FILESDIR}/1.29.0/0007-Add-openssl-configuration-for-musl-targets.patch"
	"${FILESDIR}/1.29.0/0008-Don-t-pass-CFLAGS-to-the-C-compiler.patch"
	"${FILESDIR}/1.29.0/0009-liblibc.patch"
	"${FILESDIR}/1.29.0/0010-llvm.patch"
)
