...
PATCHES=(
	"${FILESDIR}/1.31.1/0001-Don-t-pass-CFLAGS-to-the-C-compiler.patch"
	"${FILESDIR}/1.31.1/0002-Fix-LLVM-build.patch"
	"${FILESDIR}/1.31.1/0003-Allow-rustdoc-to-work-when-cross-compiling-on-musl.patch"
	"${FILESDIR}/1.31.1/0004-Require-static-native-libraries-when-linking-static-.patch"
	"${FILESDIR}/1.31.1/0005-Remove-nostdlib-and-musl_root-from-musl-targets.patch"
	"${FILESDIR}/1.31.1/0006-Prefer-libgcc_eh-over-libunwind-for-musl.patch"
	"${FILESDIR}/1.31.1/0007-Add-powerpc-unknown-linux-musl-target.patch"
	"${FILESDIR}/1.31.1/0008-Fix-powerpc64-ELFv2-big-endian-struct-passing-ABI.patch"
	"${FILESDIR}/1.31.1/0009-Use-the-ELFv2-ABI-on-powerpc64-musl.patch"
	"${FILESDIR}/1.31.1/0010-Add-powerpc64-unknown-linux-musl-target.patch"
	"${FILESDIR}/1.31.1/0011-rustc_data_structures-use-libc-types-constants-in-fl.patch"
	"${FILESDIR}/1.31.1/0012-runtest-Fix-proc-macro-tests-on-musl-hosts.patch"
	"${FILESDIR}/1.31.1/0013-Fix-double_check-tests-on-big-endian-targets.patch"
	"${FILESDIR}/1.31.1/0014-test-invalid_const_promotion-Accept-SIGTRAP-as-a-val.patch"
	"${FILESDIR}/1.31.1/0015-test-linkage-visibility-Ensure-symbols-are-visible-t.patch"
	"${FILESDIR}/1.31.1/0016-test-target-feature-gate-Only-run-on-relevant-target.patch"
	"${FILESDIR}/1.31.1/0017-test-use-extern-for-plugins-Don-t-assume-multilib.patch"
	"${FILESDIR}/1.31.1/0018-test-sysroot-crates-are-unstable-Fix-test-when-rpath.patch"
	"${FILESDIR}/1.31.1/0019-Ignore-broken-and-non-applicable-tests.patch"
	"${FILESDIR}/1.31.1/0020-Link-stage-2-tools-dynamically-to-libstd.patch"
	"${FILESDIR}/1.31.1/0021-Move-debugger-scripts-to-usr-share-rust.patch"
	"${FILESDIR}/1.31.1/0022-Add-gentoo-target-specs.patch"
	"${FILESDIR}/1.31.1/0030-liblibc-linkage.patch"
	"${FILESDIR}/1.31.1/0031-liblibc-1b130d4c349d.patch"
	"${FILESDIR}/1.31.1/0040-rls-atomics.patch"
	"${FILESDIR}/1.31.1/0050-llvm.patch"
	"${FILESDIR}/1.31.1/0051-llvm-D45520.patch"
	"${FILESDIR}/1.31.1/0052-llvm-D52013.patch"
	"${FILESDIR}/1.31.1/0053-llvm-secureplt.patch"
)
