...
IUSE="${IUSE} dbus debug neon pulseaudio alsa selinux startup-notification system-harfbuzz
...
if [[ -n ${MOZCONFIG_OPTIONAL_WIFI} ]]; then
	...
	RDEPEND+="
	wifi? ( >=sys-apps/dbus-0.60 >=dev-libs/dbus-glib-0.72 net-misc/networkmanager )"
fi
